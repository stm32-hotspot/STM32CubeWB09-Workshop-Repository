...
/** @defgroup STM32WB0X_NUCLEO STM32WB0X_NUCLEO
  * @{
  */

/** @defgroup STM32WB0X_NUCLEO_COMMON STM32WB0X_NUCLEO COMMON
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on STM32WB0x-Nucleo Kit from STMicroelectronics.
  * @{
  */

/** @defgroup STM32WB0X_NUCLEO_COMMON_Private_Defines STM32WB0X_NUCLEO COMMON Private Defines
  * @{
  */
...
/** @defgroup STM32WB0X_NUCLEO_COMMON_Private_TypesDefinitions STM32WB0X_NUCLEO COMMON Private Types Definitions
  * @{
  */
/**
  * @}
...
/** @defgroup STM32WB0X_NUCLEO_COMMON_Private_FunctionPrototypes STM32WB0X_NUCLEO COMMON Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32WB0X_NUCLEO_COMMON_Exported_Variables STM32WB0X_NUCLEO COMMON Exported Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @defgroup STM32WB0X_NUCLEO_COMMON_Private_Variables STM32WB0X_NUCLEO COMMON Private Variables
  * @{
  */
...
/** @defgroup STM32WB0X_NUCLEO_COMMON_Exported_Functions STM32WB0X_NUCLEO COMMON Exported Functions
  * @{
  */

/**
  * @brief  This method returns the STM32WB0x NUCLEO BSP Driver revision.
  * @retval version : 0xXYZR (8bits for each decimal, R for RC).
  */
int32_t BSP_GetVersion(void)
{
  return ((int32_t)STM32WB0x_NUCLEO_BSP_VERSION);
}
...
{
  return (const uint8_t*)STM32WB0X_NUCLEO_BSP_BOARD_NAME;
}
...
{
  return (const uint8_t*)STM32WB0X_NUCLEO_BSP_BOARD_ID;
}

/** @defgroup STM32WB0X_NUCLEO_COMMON_LED_Functions STM32WB0X_NUCLEO COMMON LED Functions
  * @{
  */
...
/** @defgroup STM32WB0X_NUCLEO_COMMON_BUTTON_Functions STM32WB0X_NUCLEO_COMMON BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
/** @defgroup STM32WB0X_NUCLEO_COMMON_COM_Functions STM32WB0X_NUCLEO COMMON COM Functions
  * @{
  */
...
/** @defgroup STM32WB0X_NUCLEO_COMMON_Private_Functions STM32WB0X_NUCLEO COMMON Private Functions
  * @{
  */
