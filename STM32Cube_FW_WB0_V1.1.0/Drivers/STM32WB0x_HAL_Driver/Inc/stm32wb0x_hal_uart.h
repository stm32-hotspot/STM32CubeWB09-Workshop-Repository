...
#ifndef STM32WB0x_HAL_UART_H
#define STM32WB0x_HAL_UART_H
...
/** @brief  Check UART Baud rate.
  ...
  *         The maximum Baud Rate is derived from the maximum clock on WB0 (i.e. 16 MHz)
...
#include "stm32wb0x_hal_uart_ex.h"
